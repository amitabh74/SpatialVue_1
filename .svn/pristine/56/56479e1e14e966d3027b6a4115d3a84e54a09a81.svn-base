...
<script language="javascript">
		var loggedUser=null;
		 var tDlg = new $.timeoutDialog({
			 timeout: 900,   
				countdown: 60,   
				logout_redirect_url: '/spatialvue/j_spring_security_logout',
				keep_alive_url: '/spatialvue/studio/keepalive/'
		 });
...
<body>
	...
	<div id="container">
		...
		<div id="header">
			<div class="widthheader">
				<div class="leftheader">
					...
					%>
					<img
						src="<c:url value="resources/images/viewer/logo-text_welsch.png" />" />
					...
					<div class="greyInfo">
						...
						<div align="right" class="snowdonai_welcome_text">
							...
							<div style="clear: both;">
								...
								<!-- div class="language">
										Backgroung<input type="submit" name="changeBgColor" value="" id="changeBgColor" 
										class="btnbgcolor" style="background-color:#FFFFFF;">										
									</div-->
								<div class="signoutBTN">
									<a href="/spatialvue/j_spring_security_logout"
										class="signoutTXT"><span id="signout">Sign Out</span></a>
								</div>
		...
		<div class="toolBarBG">
			...
			<div
				...
				<div style="padding-top: 5px; padding-left: 0px;">
					<label for="scale" style="height: 1.6em; color: #fff;">1:</label> <select
						id="scale-interval" style="height: 1.6em; width: 80px;">
		...
		<div class="mainContainer">
			...
			<a href="http://spatialvue.rmsi.com" target="_blank"><div
					class="poweredBy"></div></a>
